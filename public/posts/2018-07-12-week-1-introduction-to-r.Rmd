...
tags:
  - r tips
slug: week-1-introduction-to-r
output:
  blogdown::html_page:
    toc: yes
description: Week 1 of Data Analysis with R- Commence first steps with R using RStudio.
  Learn about data types and object types in R, and begin using these object types.
---
...
Read more about R and RStudio here: [R](https://en.wikipedia.org/wiki/R_(programming_language)), [RStudio](https://en.wikipedia.org/wiki/RStudio)
Install R and RStudio here: [install R](https://cran.r-project.org), [install RStudio](https://www.rstudio.com/products/rstudio/download/#download)

# RStudio interface

![](/posts/2018-07-12-day-1-introduction-to-r_files/rstudio interface.png){width=100px}
...
![](/posts/2018-07-12-day-1-introduction-to-r_files/objects.png){width=100%}
...
![](/posts/2018-07-12-day-1-introduction-to-r_files/row bind.png){width=100%}

In **column bind**, we add one matrix on the right side of another matrix

![](/posts/2018-07-12-day-1-introduction-to-r_files/column bind.png){width=100%}
